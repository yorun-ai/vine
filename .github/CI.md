...
| Go production source, module files, backend resources or test fixtures | Full ordinary Go tests and leak checks, static checks including Linux static compilation, targeted race; module files also select image builds |
...
Hub, Link and Portal images in the PR. Ordinary Go source and backend resource changes instead
...
The image check builds Linux AMD64 without publishing. All three image targets and
