...
func TestDashboardWebProxyForwardsRequestPath(t *testing.T) {
	...
	ginCtx.Request = httptest.NewRequest(http.MethodGet, "http://demo.local/vine.hub.admin.DashboardWeb/assets/app.js?v=1", nil)
...
func TestDashboardWebSkipsProxyWhenDevProxyDisabled(t *testing.T) {
	...
	recorder := &closeNotifyRecorder{ResponseRecorder: httptest.NewRecorder()}
	ginCtx, _ := gin.CreateTestContext(recorder)
	ginCtx.Request = httptest.NewRequest(http.MethodGet, "http://demo.local/vine.hub.admin.DashboardWeb/", nil)
...
func TestDashboardWebServesEmbeddedAssetWhenProxyUnavailable(t *testing.T) {
	...
	recorder := &closeNotifyRecorder{ResponseRecorder: httptest.NewRecorder()}
	ginCtx, _ := gin.CreateTestContext(recorder)
	ginCtx.Request = httptest.NewRequest(http.MethodGet, "http://demo.local/vine.hub.admin.DashboardWeb/brand/vinehub.png", nil)
...
func TestDashboardWebFallsBackToEmbeddedIndexForSpaRoute(t *testing.T) {
	...
	recorder := &closeNotifyRecorder{ResponseRecorder: httptest.NewRecorder()}
	ginCtx, _ := gin.CreateTestContext(recorder)
	ginCtx.Request = httptest.NewRequest(http.MethodGet, "http://demo.local/vine.hub.admin.DashboardWeb/portal/site", nil)
...
func TestDashboardWebDoesNotFallbackToIndexForMissingAsset(t *testing.T) {
	...
	recorder := &closeNotifyRecorder{ResponseRecorder: httptest.NewRecorder()}
	ginCtx, _ := gin.CreateTestContext(recorder)
	ginCtx.Request = httptest.NewRequest(http.MethodGet, "http://demo.local/vine.hub.admin.DashboardWeb/assets/missing.js", nil)
