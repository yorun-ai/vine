    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'task-queue',
            label: cnDictionary['nav.taskQueue.label'],
            labelKey: 'nav.taskQueue.label',
            description: cnDictionary['nav.taskQueue.description'],
            descriptionKey: 'nav.taskQueue.description',
            to: '/status/task-queue',
            icon: CalendarClock,
          },
          {
            id: 'event-queue',
            label: cnDictionary['nav.eventQueue.label'],
            labelKey: 'nav.eventQueue.label',
            description: cnDictionary['nav.eventQueue.description'],
            descriptionKey: 'nav.eventQueue.description',
            to: '/status/event-queue',
            icon: Radio,
          },
          {
            id: 'portal-instance',
            ...
            description: cnDictionary['nav.portalInstance.description'],
            descriptionKey: 'nav.portalInstance.description',
            to: '/status/portal',
            icon: Rocket,
          },
        ],
