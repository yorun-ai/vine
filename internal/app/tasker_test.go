...
var registerTaskerTaskOnce = func() func() {
	...
	return func() {
		...
		taskspec.Register(&taskspec.TaskSpec{
			...
			RunnerType:          reflect.TypeFor[testTaskerRunner](),
			DefaultRunnerType:   reflect.TypeFor[*defaultTestTaskerRunner](),
			ERRunnerType:        reflect.TypeFor[testTaskerRunnerER](),
			WrapperERRunnerCtor: newWrapperTestTaskerRunnerER,
			DefaultERRunnerType: reflect.TypeFor[*defaultTestTaskerRunnerER](),
			LauncherType:        reflect.TypeFor[testTaskerRunnerLauncher](),
			...
			Triggers: []*taskspec.TriggerSpec{{
				...
				ArgumentsType:    reflect.TypeFor[testTaskerRunArguments](),
			}, {
				Name:             "EveryHour",
				SkelName:         "everyHour",
